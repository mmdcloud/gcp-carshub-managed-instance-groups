...
import { vehicleOwnerSchema } from "../../../utils/form-schemas";
...
const VehicleOwnerForm = () => {
    ...
    const mutation = useMutation({
        mutationFn: (payload) => {
            return axiosInstance.post('/vehicle-owners', payload);
        },
    ...
    const updateMutation = useMutation({
        mutationFn: (payload) => {
            return axiosInstance.patch('/vehicle-owners/' + params.get("id"), payload);
        },
        onSuccess: (data, variables, context) => {
