...
import { vehicleModelSchema } from "../../../utils/form-schemas";
...
const VehicleModelForm = () => {
    ...
    const mutation = useMutation({
        mutationFn: (payload) => {
            return axiosInstance.post('/vehicle-models', payload);
        },
    ...
    useEffect(() => {
        if (params.get("id") !== null) {
            ...
            formik.setFieldValue("brandId", params.get("brandId"));
        }
    }, []);
    const updateMutation = useMutation({
        mutationFn: (payload) => {
            return axiosInstance.patch('/vehicle-models/' + params.get("id"), payload);
        },
        onSuccess: (data, variables, context) => {
                    ...
                    <div className="p-6.5">
                        ...
                        <div className="mb-5.5">
                            ...
                            {formik.errors.brandId && formik.touched.brandId ? (
                                <div className="text-red mt-2">{formik.errors.brandId}</div>
                            ) : null}
                        </div>
